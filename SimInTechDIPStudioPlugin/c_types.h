...
typedef int (_cdecl *t_glob_obj_destructor_proc)(void* aGlobalObjPtr);
...
typedef struct {
  ...
  void    (_cdecl *RegisterGlobalObject)(void* ALayerContext,char* aGlobObjectName,void* aNewObject,t_glob_obj_destructor_proc destructor_proc_ptr);
    /* Регистрация нужной библиотеки и получение от неё функций */
  int     (_cdecl *DoLoadNeedPlugin)(char* aPluginName);    
  ...
  unsigned char  (_cdecl *GetDataPtr)(void* TaskContext, char* aSignalName, void** DataPtr, int* dimension); 
    /* Проверка необходимости принудительной остановки  */
  char    (_cdecl *StopCheck)(void* TaskContext);  
